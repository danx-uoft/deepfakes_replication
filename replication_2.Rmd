...
load("/Users/dans/Documents/Github/Political-Deepfakes-Fx/Political-Deepfakes-Fx-main/deepfake.RData")
...
#####------------------------------------------------------#
```{r}
cps2018_ <- readRDS("/Users/dans/Documents/Github/Political-Deepfakes-Fx/Political-Deepfakes-Fx-main/cps2018_crosstabs.rds")
cps2018 <- cps2018_
...
```{r}
## educ
cps2018educ <- read_delim("/Users/dans/Documents/Github/Political-Deepfakes-Fx/Political-Deepfakes-Fx-main/cps2018_crosstabs_educ.txt", delim="|",
                       col_names = c("cat", "n"))
...
```{r}
## income
cps2018inc_f <- readLines("/Users/dans/Documents/Github/Political-Deepfakes-Fx/Political-Deepfakes-Fx-main/cps2018_crosstabs_income.txt")
...
# There is no rid, I need to create a row/response ID on my own
dd$rid <- seq.int(nrow(dd)) 
dd %>% 
select(rid, everything())


dat$rid <- seq.int(nrow(dat)) 
dat %>% 
select(rid, everything())
...
data <- dat %>% 
  ...
  select(rid, weight, everything())

data$weight[is.na(data$weight)] <- 0


# check the data 
unique(data$age) # "2000" "E2" "truthfully" 
unique(data$Zip) # 1 digit, 4 - digit
unique(data$educ) # College      Postgraduate High school  <High school N/A <High school High school College Postgraduate
unique(data$gender) # Male < Female < Other < <NA>
## Weird strings 

## update data file
save(data, dfsurvdat, nofake_vids, lowfake_vids, hifake_vids, 
     file = "/Users/dans/Documents/Github/Political-Deepfakes-Fx/deepfake.RData")
